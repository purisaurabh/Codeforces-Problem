...
Initially the children stood in the order they entered the canteen.
 However, after a while the boys started feeling awkward for 
...
at that the person in the position number 1 is served first. Then, 
...
which represent the number of children in the queue and the time after 
